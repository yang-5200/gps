<template>
	<view class="cu-picker-view">
		<picker-view  class="d-picker-view" :indicator-style="itemHeight" :value="pickVal" @change="handlerChange">
			<picker-view-column class="cu-picker-flex2">
				<view class="cu-picker-item" v-for="(item,index) in range.fyears" :key="index">{{item}}年</view>
			</picker-view-column>
			<picker-view-column class="cu-picker-flex2">
				<view class="cu-picker-item" v-for="(item,index) in range.fmonths" :key="index">{{item}}月</view>
			</picker-view-column>
			<picker-view-column class="cu-picker-flex2">
				<view class="cu-picker-item" v-for="(item,index) in range.fdays" :key="index">{{item}}日</view>
			</picker-view-column>
			<picker-view-column class="cu-picker-flex1">
				<view class="cu-picker-item">-</view>
			</picker-view-column>
			<picker-view-column class="cu-picker-flex2">
				<view class="cu-picker-item" v-for="(item,index) in range.tyears" :key="index">{{item}}年</view>
			</picker-view-column>
			<picker-view-column class="cu-picker-flex2">
				<view class="cu-picker-item" v-for="(item,index) in range.tmonths" :key="index">{{item}}月</view>
			</picker-view-column>
			<picker-view-column class="cu-picker-flex2">
				<view class="cu-picker-item" v-for="(item,index) in range.tdays" :key="index">{{item}}日</view>
			</picker-view-column>
		</picker-view>
	</view>
</template>
