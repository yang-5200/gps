<template>
	<cu-layer v-model="isShow" mode="center" :maskClosable="popObj.isBack" @close="cancel()" :cu-zindex="102">
		<view class="modal-pop bg-white">
			...
			<view class="pop-body" >
				<view :style="popObj.contentStyle" v-if="popObj.type == 'alert'" class="type-alert content text-center">
					<cu-parser :html="popObj.content"></cu-parser>
				</view>
			</view>
			<view class="pop-footer">
				<!-- 需要取消按钮 start-->
				<view v-if="popObj.showCancel" class="btns type-1 border-top flex align-center justify-between">
