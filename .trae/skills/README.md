...
| [项目初始化与基础设施搭建](./uniapp-vue3/project-bootstrap.md) | ⭐ **自生能力核心**：定义新项目如何从零搭建基础设施 | infrastructure, init |
...
| [搜索栏组件](./uniapp-vue3/search-bar-component.md) | 🔍 搜索输入框组件，支持 v-model、清除、禁用跳转、操作按钮 | component, search, input |
| [单元格组件](./uniapp-vue3/cell-component.md) | 📋 列表单元格组件，适用于设置页、详情页、信息列表 | component, cell, list |
| [标签组件](./uniapp-vue3/tag-component.md) | 🏷️ 标签组件，支持多种主题色、尺寸、空心、圆角、可关闭 | component, tag, status |
| [骨架屏组件](./uniapp-vue3/skeleton-component.md) | 💀 骨架屏占位组件，支持头像、文本行、闪烁动画 | component, skeleton, loading |
